...
public class ErrorResponseBooking extends Throwable implements Serializable {
    ...
    public ErrorResponseBooking() {}

    public ErrorResponseBooking(String errorMessage) {
        super();
    ...
    public ErrorResponseBooking withErrorMessage(String errorMessage) {
        this.errorMessage = errorMessage;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ErrorResponseBooking) == false) {
            return false;
        }
        ErrorResponseBooking rhs = ((ErrorResponseBooking) other);
