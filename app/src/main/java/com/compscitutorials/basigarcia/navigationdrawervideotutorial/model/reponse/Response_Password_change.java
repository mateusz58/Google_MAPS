...
public class Response_Password_change implements Serializable
{
     ...
     *
     */
    public Response_Password_change() {
    }
     ...
     * @param detail
     */
    public Response_Password_change(String detail) {
        super();
        this.detail = detail;
    }
    ...
    public Response_Password_change withDetail(String detail) {
        this.detail = detail;
        return this;
    }
