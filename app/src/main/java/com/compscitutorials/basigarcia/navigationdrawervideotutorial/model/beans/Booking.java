...
public class Booking implements Serializable
{
    ...
    private final static long serialVersionUID = 6909003807465914184L;
     ...
     * @param cost
     */
    public Booking(Integer id, Integer parking, Float cost, Object user, Integer numberOfCars, Boolean active, String dateFrom, String dateTo) {
        super();
        this.id = id;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", id).append("parking", parking).append("cost", cost).append("user", user).append("numberOfCars", numberOfCars).append("active", active).append("dateFrom", dateFrom).append("dateTo", dateTo).toString();
    }
